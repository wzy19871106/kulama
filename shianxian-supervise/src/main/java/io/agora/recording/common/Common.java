...
public class Common{
  ...
  public enum LEAVE_PATH_CODE {
    ...
    /** 4: The recording application calls the {@link io.agora.recording.RecordingSDK.leaveChannel leaveChannel} method to leave the channel. */
  ...
  /** Warning codes.
   *
   * @note When using the Recording SDK, you may receive warning codes from the Native SDK. See more<a href="https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/java/classio_1_1agora_1_1rtc_1_1_i_rtc_engine_event_handler_1_1_warn_code.html">warning codes</a>.
   */
   ...
   * 
   * See <a href="https://docs.agora.io/en/faq/recording_player">Supported Players</a>.
   */
  ...
  public class VideoMixingLayout
  {
    ...
    public class Region {
      ...
      */
      ...
      /**  Render mode:
       * <ul>
       *   <li> RENDER_MODE_HIDDEN(0): Cropped mode. Uniformly scale the video until it fills the visible boundaries (cropped). One dimension of the video may have clipped contents.</li>
