...
public interface RecordingEventHandler {
   ...
   *
	 ...
	 *
	 * @param reason The reasons why the recording app leaves the channel. See {@link Common#LEAVE_PATH_CODE LEAVE_PATH_CODE}.
	 */
   ...
   *
	 * @param error {@link Common#ERROR_CODE_TYPE Error codes}.
	 * @param stat_code {@link Common#STAT_CODE_TYPE State codes}.
	 */
   ...
   * In most cases, the app can ignore the warnings reported by the SDK because
	 ...
	 *
   * @param warn {@link Common#WARN_CODE_TYPE Warning codes}.
	 */
   ...
   *
	 * @param uid User ID of the user.
	 * @param reason The rerasons why the user leaves the channel or goes offline. See {@link Common#USER_OFFLINE_REASON_TYPE USER_OFFLINE_REASON_TYPE}.
	 */
   ...
   * @param rotation Rotational angle: 0, 90, 180, or 270.
	...
	void recordingPathCallBack(String path);
	   ...
	   * @param speakers    An array containing the user ID and volume information for each speaker. For more information, see {@link Common#AudioVolumeInfo AudioVolumeInfo}。
